...
MAINTAINER Mingjie_Wang huzai@sjtu.edu.cn
...
RUN apt update 
RUN apt install -y --force-yes vim libatlas3-base r-base r-base-dev bioperl make gcc autoconf automake g++ pkg-config libpcre3 libpcre3-dev libgcrypt11-dev zlib1g-dev 
RUN cd /opt/qap 
