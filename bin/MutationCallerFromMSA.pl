...
printcol ("MutationCallerFromMSA","green");
print "\n";
...
if (defined $outputDir){
	...
	$outputDir = File::Spec -> catfile($wk_dir,"qap_Results_for_MutationCallerFromMSA_$DateNow");
...
gap MutationCallerFromMSA [options]
...
gap MutationCallerFromMSA -i test.bam -r HBV.fasta -o ./mutation
