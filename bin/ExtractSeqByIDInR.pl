...
printcol ("ExtractSeqByIDInR","green");
print "\n";
...
if (defined $outputDir){
	...
	$outputDir = File::Spec -> catfile($wk_dir,"qap_Results_for_ExtractSeqByIDInR_$DateNow");
...
Path of the directory to storage the splitted reads data. If NOT provided, the directory of raw data files would be used instead.
...
gap ExtractSeqByIDInR -1 Data1_R1.fq.gz -2 Data1_R2.fq.gz -i readID.txt -f fastq -o ./seq
