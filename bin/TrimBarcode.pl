...
if (defined $outputDir){
	...
	$outputDir = File::Spec -> catfile($wk_dir,"qap_Results_for_TrimBarcode_$DateNow");
...
gap TrimBarcode -1 Data1_R1.fq.gz,Data2_R1.fq.gz,Data3_R1.fq.gz -2 Data1_R2.fq.gz,Data2_R2.fq.gz,Data3_R2.fq.gz -l 8 -p bos -t 2 -o ./timmedSep
