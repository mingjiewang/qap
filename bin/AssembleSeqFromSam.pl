...
printcol ("AssembleSeqFromSam","green");
print "\n";
...
if (defined $outputDir){
	...
	$outputDir = File::Spec -> catfile($wk_dir,"qap_Results_for_AssembleSeqFromSam_$DateNow");
...
gap AssembleSeqFromSam [options]
...
gap AssembleSeqFromSam -i test.sam - -p nnt -t 10 -o ./shannon
