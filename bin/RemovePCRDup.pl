...
=item --format,-f F<STRING> [Optional]

Format of output files. Two values are allowd: 'bam' or 'sam'. If --format/-f is not specified, -f bam will be used as default.
...
gap RemovePCRDup -i test1.bam,test2.bam -t 5 -p s -f sam -o ./rmdup
